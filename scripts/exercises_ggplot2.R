...
# Save each of following plots in the plots folder
...
## Extra: Use the fill or colour aesthetic to make it a little bit more colorful


## 6. Add an extra layer to 5 using geom_point over the boxplot. 
